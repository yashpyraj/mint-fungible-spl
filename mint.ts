...
const MY_TOKEN_METADATA: UploadMetadataInput = {
  ...
  image: "https://i.postimg.cc/fL2pZFRG/chats.png", //add public URL to image you'd like to use
};

const ON_CHAIN_METADATA = {
  name: MY_TOKEN_METADATA.name,
  symbol: MY_TOKEN_METADATA.symbol,
  uri: "https://github.com/yashpyraj/solana_add_metadata/blob/main/metadata.json",
